...
/*
Fermeture d'une image pgm, application d'une dilatation puis d'une erosion
*/
...
int main(int argc, char* argv[]) {
    ...
    // Application de la fonction dilatation et erosion
    dilatation(ImgIn, ImgDil, nH, nW);
    erosion(ImgDil, ImgOut, nH, nW);
