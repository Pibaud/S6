...
avec des formules mathematiques. Dans ce programme, on inverse la valeur vert et bleu
*/
...
int main(int argc, char *argv[]) {
    ...
    for (int i = 0; i < nTaille3; i += 3) {
        ...
        int nB = ImgInY[i / 3] - 0.34414 * (ImgInCb[i / 3] - 128) - 0.714414 * (ImgInCr[i / 3] - 128);
        int nG = ImgInY[i / 3] + 1.772 * (ImgInCb[i / 3] - 128);
